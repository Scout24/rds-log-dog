...
class TestS3Utils(unittest.TestCase):
    ...
    @mock_s3
    def fest_list_s3_folders_on_non_existing_folder(self):
        self.s3.create_bucket(Bucket='mybucket')
        self.assertEqual(set(), list_folders(
            Bucket='mybucket', Prefix='folder1'))

    @mock_s3
    def fest_list_s3_folders_on_empty_folder(self):
        self.s3.create_bucket(Bucket='mybucket')
    ...
    @mock_s3
    def fest_list_s3_folders_on_only_files(self):
        self.s3.create_bucket(Bucket='mybucket')
    ...
    @mock_s3
    def fest_list_s3_folders_flat(self):
        self.s3.create_bucket(Bucket='mybucket')
    ...
    @mock_s3
    def fest_list_s3_folders_nested(self):
        self.s3.create_bucket(Bucket='mybucket')
    ...
    def fest_get_top_level_folder_under_prefix_top_level_folder(self):
        self.assertEqual('folder1', get_top_level_folder_under_prefix(
            'rds_log/folder1/', 'rds_log'))

    def fest_get_top_level_folder_under_prefix_2nd_level_folder(self):
        self.assertEqual('folder1', get_top_level_folder_under_prefix(
            'rds_log/folder1/subfolder/', 'rds_log'))

    def fest_get_top_level_folder_under_prefix_2nd_level_file(self):
        self.assertEqual('folder1', get_top_level_folder_under_prefix(
            'rds_log/folder1/file', 'rds_log'))

    def fest_get_top_level_folder_under_prefix_top_level_file(self):
        self.assertEqual(None, get_top_level_folder_under_prefix(
            'rds_log/folder1', 'rds_log'))

    def fest_get_top_level_folder_under_prefix_with_tricky_foldername(self):
    ...
    def fest_get_top_level_folder_under_prefix_with_parent_end_w_slash(self):
        # wrong
    ...
    # TODO/FIXME: unimplemented or wrong usage
    def fest_get_top_level_folder_under_prefix_with_no_parent(self):
        with self.assertRaises(Exception):
            self.assertEqual(None, get_top_level_folder_under_prefix(
                'rds/folder1/', None))

    @mock_s3
    def fest_write_data_to_object(self):
